...
>(
  (
    ...
    const addJavaScriptFeatures = (monaco: typeof import('monaco-editor')) => {
      // Debounced validation on content change
      let validationTimeout: NodeJS.Timeout;
    ...
    const addTypeScriptFeatures = (monaco: typeof import('monaco-editor')) => {
      // Debounced validation on content change
      let validationTimeout: NodeJS.Timeout;
    ...
    const addPythonFeatures = (monaco: typeof import('monaco-editor')) => {
    ...
    const addRFeatures = (monaco: typeof import('monaco-editor')) => {
