...
export const readSecretAction = async (
  ...
  try {
    ...
    console.error('Error in readSecretAction:', error);
    return null;
  }
};
...
export const createSecretAction = async (
  ...
  try {
    ...
    console.error('Error in createSecretAction:', error);
    return null;
  }
};
...
export const getSecretsByCategoryAction = async (
  ...
  try {
    ...
    console.error('Error in getSecretsByCategoryAction:', error);
    return null;
  }
};
...
export const getSecretsByFlowIdAction = async (
  ...
  try {
    ...
    console.error('Error in getSecretsByFlowIdAction:', error);
    return null;
  }
};
...
export const getSecretsByNodeIdAction = async (
  ...
  try {
    ...
    console.error('Error in getSecretsByNodeIdAction:', error);
    return null;
  }
};
...
export const deleteSecretAction = async (
  ...
  try {
    ...
    console.error('Error in deleteSecretAction:', error);
    return null;
  }
};
...
export const updateSecretAction = async (
  ...
  try {
    ...
    console.error('Error in updateSecretAction:', error);
    return null;
  }
};
...
export const getAllRelevantSecretsAction = async (params: {
  ...
  try {
    ...
    console.error('Error in getAllRelevantSecretsAction:', error);
    return null;
  }
};
