...
export const getFlowEvents = async (
  ...
  try {
    ...
    console.error('Failed to fetch flow events:', error);
    return [];
  }
};
...
export const getFlowEventsByIds = async (
  ...
  try {
    ...
    console.error('Failed to fetch flow events by IDs:', error);
    return [];
  }
};
...
export const getFlowEvent = async (
  ...
  try {
    ...
    console.error(`Failed to fetch flow event with ID ${id}:`, error);
    return null;
  }
};
...
export const createFlowEvent = async (
  ...
  try {
    ...
    console.error('Failed to create flow event:', error);
    return null;
  }
};
...
export const getFlowEventsByFlowRunId = async (
  ...
  try {
    ...
    console.error(
      `Failed to fetch flow events for flow run ID ${flowRunId}:`,
      error,
    );
    return [];
  }
