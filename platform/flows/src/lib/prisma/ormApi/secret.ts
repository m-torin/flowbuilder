...
export const getSecretById = async (
  ...
  try {
    ...
    console.error(`Error fetching secret with ID ${secretId}:`, error);
    return null;
  }
};
...
export const getSecretsByFlowId = async (
  ...
  try {
    ...
    console.error(`Error fetching secrets by flow ID ${flowId}:`, error);
    return null;
  }
};
...
export const getSecretsByNodeId = async (
  ...
  try {
    ...
    console.error(`Error fetching secrets by node ID ${nodeId}:`, error);
    return null;
  }
};
...
export const updateSecret = async (
  ...
  try {
    ...
    console.error(`Error updating secret with ID ${secretId}:`, error);
    return null;
  }
};
...
export const getAllRelevantSecrets = async (params: {
  ...
  try {
    ...
    console.error('Error fetching relevant secrets:', error);
    return null;
  }
};
