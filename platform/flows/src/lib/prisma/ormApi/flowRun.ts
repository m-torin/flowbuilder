...
export const getFlowRunsByIds = async (
  ...
  try {
    ...
    console.error('Failed to fetch flow runs by IDs:', error);
    return [];
  }
};
...
export const getFlowRun = async (
  ...
  try {
    ...
    console.error(`Failed to fetch flow run with ID ${id}:`, error);
    return null;
  }
};
...
export const getFlowRunsByFlowId = async (
  ...
  try {
    ...
    console.error(`Failed to fetch flow runs for flow ID ${flowId}:`, error);
    return [];
  }
};
