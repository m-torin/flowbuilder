...
const destinationSettingsSchema = z
  .object({
    ...
    queryParams: z.union([z.string(), z.record(z.string())]).optional(),
...
export const formErrorMap: z.ZodErrorMap = (error, ctx) => {
  switch (error.code) {
    ...
    case z.ZodIssueCode.invalid_enum_value:
      return {
        message: `Invalid option. Valid options are: ${error.options.join(', ')}`,
      };
