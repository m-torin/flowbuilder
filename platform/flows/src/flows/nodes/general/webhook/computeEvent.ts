...
const handleDestinationEvent = async (
  ...
  console.log('Starting destination webhook handling:', { input, data });
  ...
  try {
    ...
    console.error('Destination webhook request failed:', error);
    throw error;
  }
};
...
export const computeFunction = async (
  ...
  try {
    console.log('Starting webhook computation:', {
    ...
    console.error('Webhook computation failed:', error);
