...
const handleSourceSubmit = async (values: FormValues): Promise<void> => {
  ...
  console.log('Processing EventBridge source configuration:', {
...
const handleDestinationSubmit = async (values: FormValues): Promise<void> => {
  ...
  console.log('Processing EventBridge destination configuration:', {
...
const handleEnrichmentSubmit = async (values: FormValues): Promise<void> => {
  ...
  console.log('Processing EventBridge enrichment configuration:', {
...
export const handleSubmit = async (
  ...
  try {
    console.log('Processing EventBridge form submission:', {
    ...
    console.error('EventBridge form submission failed:', error);
    return {
      success: false,
      error:
