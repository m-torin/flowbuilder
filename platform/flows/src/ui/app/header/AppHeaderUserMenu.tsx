...
export const AppHeaderUserMenu: React.FC = () => {
  ...
  const toggleIconColor = `var(${computedColorScheme === 'dark' ? '--mantine-color-yellow-2' : '--mantine-color-blue-9'})`;

  const menuItemData = useMemo(
    () => getMenuItemData(computedColorScheme, toggleColorScheme),
